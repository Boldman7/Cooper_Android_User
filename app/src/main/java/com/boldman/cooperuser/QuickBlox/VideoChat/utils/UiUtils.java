...
public class UiUtils {
    ...
    public static Drawable getGreyCircleDrawable() {
        return getColoredCircleDrawable(CooperUserApplication.getInstance().getResources().getColor(R.color.color_grey));
    }
    ...
    public static Drawable getColoredCircleDrawable(@ColorInt int color) {
        GradientDrawable drawable = (GradientDrawable) CooperUserApplication.getInstance().getResources().getDrawable(R.drawable.shape_circle);
    ...
    public static int getCircleColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
        ...
        int colorId = CooperUserApplication.getInstance().getResources()
                .getIdentifier(colorIdName, "color", CooperUserApplication.getInstance().getPackageName());

        return CooperUserApplication.getInstance().getResources().getColor(colorId);
    }
