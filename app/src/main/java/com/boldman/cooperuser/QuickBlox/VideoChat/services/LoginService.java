...
import com.boldman.cooperuser.QuickBlox.VideoChat.util.ChatPingAlarmManager;
...
//        }
    ...
    private void initQBRTCClient() {
        ...
        Log.d(TAG, "initQBRTCClient XXXXXXXXXXXX");
        ...
        chatService.getVideoChatWebRTCSignalingManager().addSignalingManagerListener(new QBVideoChatSignalingManagerListener() {
            ...
            public void signalingCreated(QBSignaling qbSignaling, boolean createdLocally) {
                ...
                Log.d(TAG, "initQBRTCClient XXXXXXXXXXXX" + createdLocally);

                if (!createdLocally) {

                    Log.d(TAG, "addSignalingManagerListener XXXXXXXXXXXX");
